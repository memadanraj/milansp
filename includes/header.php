      ...
      <div class="head-section">
        <div class="logo-content">
          <!--top-logo-->
              ...
              <div class="logo">
                  <a href="index.php"><img src="images/logo1.png"  alt="" width="180" height="100" /></a>
                  <h4 style="color: blue;">Old Age Home Management System</h4>
              </div>
              <div class="top-log">
                  <ul>
                  <li style="color: blue;"><a href="admin/login.php">Admin</a></li>
                  <li style="color: blue;"><a href="admin/Doctor/login.php">Doctor</a></li>
