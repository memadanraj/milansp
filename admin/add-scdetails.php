...
$sql=mysqli_query($con,"insert into tblseniorcitizen(RegistrationNumber,Name,DateofBirth,ContactNumber,CommunicationAddress,Health,ProfilePic,EmergencyAddress,EmergencyContactnumber,AddedBy) values('$regnum','$namesc','$dob','$contnum','$commadd','$Health','$propic','$emeradd','$emercontnum','$addedby')");
                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <div class="form-group">
                     ...
                     <textarea class="form-control" id="Health" name="Health" rows="5"></textarea>
                      </div>
                    <div class="form-group">
