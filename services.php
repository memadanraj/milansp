...
<!--/start-footer-->
	...
	<div class="blog">
		<div class="container">	
			...
			<div class="col-md-12" style="margin-top:4%; margin-bottom:5%;">
...
?>
            ...
            <div class="col-md-4 service-images-text" style="margin-top:15px;">
		...
		<!--<div class="col-md-12" style="margin-top:4%">
            ...
            <div class="col-md-8 service-images-text">
              <div class="inner-text">
                <h4>MY Title</h4>
                  <p>l;sdlfksdlf jsd ff lskdfkl ksklsd</p>
              </div>
